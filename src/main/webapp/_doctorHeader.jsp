...
<html>
    ...
    <body>
        <c:set var="destinations" value="patientlist/1;;profile/${sessionScope.userid}"/>
        <c:set var="links" value="Patients;;My Profile"/>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <c:forEach var="dest" items="${destinations}" varStatus="status">
                            <li class="nav-item"><a href="${pageContext.request.contextPath}/doctor/${dest}" class="nav-link">${links[status.index]}</a></li>
                        </c:forEach>
