...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/javascript/main.js">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/javascript/jquery.js">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/javascript/bootstrap.min.js">
...
<body>
	...
	<form class="form"
		action="${pageContext.request.contextPath}/doctor/updateprofile"
		method="post">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-8">
					<label for="name" style="margin: 4px 0px 0px 0px"><strong>Name
							: </strong></label> <input type="text" class="form-control" name="name" id="name"
			...
			<div class="row">
				<div class="col-4">
					<label><b>Type of Doctor :</b></label> <input type="text"
						class="form-control" name="typeofdoctor" id="type"
						value="${userForm.typeofdoctor}" readonly="">
				</div>
				<div class="col-4">
					<label><b>Degrees : </b></label> <input type="text"
						class="form-control" name="degrees" id="name"
			...
			<div class="row">
				...
				<div class="col-4">
					<label><b>Depart Time : </b></label> <input type="text"
						class="form-control" name="departtime" id="departtime" readonly=""
			...
			<div class="row">
				<div class="col-4">
					<label><b>Date of Join : </b></label> <input type="date"
						...
						value="${userForm.dateofjoin}" readonly="">
				</div>
				<div class="col-4">
					<label><b>Salary : </b></label> <input type="number" name="salary"
			...
			<div class="row">
				...
				<div class="col-4">
					<label for="email"><strong>Email :</strong></label> <input
						...
						value="${userForm.user.emailaddress}" title="enter your email.">
				</div>
			</div>
