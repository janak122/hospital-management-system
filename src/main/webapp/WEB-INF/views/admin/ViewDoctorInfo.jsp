...
<html>
	...
	<jsp:include page="adminHeader.jsp"></jsp:include>
        <div class="container">
            <ul class="nav">
                <li class="nav-item"><a href="${pageContext.request.contextPath}/admin/register/doctor/${entity.user.userId}" class="btn btn-warning">Update</a></li>
                <li class="nav-item"><a href="${pageContext.request.contextPath}/admin/delete/doctor/${entity.user.userId}" class="btn btn-danger">Delete</a></li>
            </ul>
            <hr>
            ...
            <div class="col-sm-8">  
                <div class="tab-content">
                    <div class="tab-pane active" id="home">         
                        <div class="row">
                            <div class="col-4">
                                <label><strong>Doctor Id : </strong></label><b> ${entity.user.userId}</b>
                                <input type="hidden" name="userId" value="${entity.user.userId}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <input type="text" class="form-control" name="name" id="name" 
                                       value="${entity.user.name}" title="Enter your first name" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="text" name="gender" class="form-control" readonly="" value="${entity.user.gender}">
                            </div>
                            <div class="col-4">
                                <label for="birthdate"><strong>Birthdate :</strong></label>
                                <input type="date" class="form-control" name="birthdate"
                                       value="${entity.user.birthdate}" id="birthdate" readonly="" title="enter your birthdate">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="date" class="form-control" name="dateofjoin" value="${entity.dateofjoin}" readonly="">
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" name="phoneno" id="phoneno" readonly   value="${entity.user.phoneno}" title="enter your mobile number">
                            </div>
                            <div class="col-4">
                                <label for="email"><strong>Email :</strong></label>
                                <input type="email" class="form-control" name="emailaddress" id="email" readonly=""  value="${entity.user.emailaddress}" title="enter your email.">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <input type="text" class="form-control" name="address" readonly="" id="address" value="${entity.user.address}" title="enter address">
                            </div>
                        </div>
