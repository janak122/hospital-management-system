...
<html>
    ...
    <body>
        <div class="container">
            <ul class="nav">
                <li class="nav-item"><a href="${pageContext.request.contextPath}/admin/doctorlist" class="btn btn-info">Back</a></li>
                <li class="nav-item"><a href="${pageContext.request.contextPath}/admin/doctor/addupdatedoctor/${userForm.user.userId}" class="btn btn-warning">Update</a></li>
                <li class="nav-item"><a href="${pageContext.request.contextPath}/admin/delete/doctor/${userForm.user.userId}" class="btn btn-danger">Delete</a></li>
            </ul>
            <hr>
